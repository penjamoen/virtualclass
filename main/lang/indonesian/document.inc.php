...
$langScormcontentstudent = "Ini adalah mata Pelajaran dengan format Scorm. Untuk meminkannya, klik disini : <input type=button name=scormbutton value=\'Luncurkan!\' onclick=\'openscorm()\'>";
...
$langQuotaForThisCourseIs = "Kuota pada mata Pelajaran ini adalah";
$langDel = "hapus";
$langUp = "Ke atas";
$langDate = "Tanggal";
$ShowCourseQuotaUse = "Tampilkan kuota Mata Pelajaran";
$CourseCurrentlyUses = "Mata Pelajaran ini saat ini menggunakan";
