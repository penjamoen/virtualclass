...
$TabsPlatformAdministration = "Portal Administration tab";
...
$AllowUsersToCreateCoursesTitle = "Are users (both regular users as trainers) allowed to create trainings?";
$AllowUsersToCreateCoursesComment = "If you disable this then the platform administrator is the only person who can create trainings. By doing so you get a more centrally lead organisation and control. This way the trainers have to contact the platform administrator to create a new training. This way you can manage the trainings more centrally and impose a more consistent code and name giving to the trainings. On the other hand you limit the flexibility and give less rights to the trainers. ";
